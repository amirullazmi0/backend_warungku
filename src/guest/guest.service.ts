...
import { itemStoreGuest, itemStoreGuestResponse } from './response';
...
export class GuestService {
  ...
  async getDataItemStoreGuest(
    id?: string,
    keyword?: string,
    category?: string[],
  ): Promise<WebResponse<itemStoreGuestResponse>> {
    try {
      ...
      const data: itemStoreGuest[] = await this.prismaService.$queryRaw(query);
