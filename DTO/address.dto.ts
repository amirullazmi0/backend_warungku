...
export const addressUpdateSchema = z.object({
  ...
  jalan: z
    .string()
    .min(1, 'jalan is required')
    .max(255, 'jalan is too long')
    .nullable()
    .optional(),
  rt: z
    .string()
    .min(1, 'rt is required')
    .max(255, 'rt is too long')
    .nullable()
    .optional(),
  rw: z
    .string()
    .min(1, 'rw is required')
    .max(255, 'rw is too long')
    .nullable()
    .optional(),
  kodepos: z
    .string()
  ...
  kota: z
    .string()
    .min(1, 'kota is required')
    .max(255, 'kota is too long')
    .nullable()
    .optional(),
  provinsi: z
    .string()
